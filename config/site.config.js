...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'asmr@asoul-rec.com',
  ...
  protectedRoutes: ['/Asmr', '/🥟 Some test files/Protected route'],
  ...
  // This is a day.js-style datetime format string to format datetimes in the app. Ref t
